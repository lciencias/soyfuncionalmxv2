...
if ( $_SESSION['visitante'] == $_POST['sessionId'] && 
    ...
    isset($_POST['address']) &&  trim($_POST['address']) != "" && strlen(trim($_POST['address'])) >10 &&  
    isset($_POST['delegacion']) &&  trim($_POST['delegacion']) != ""
      ...
      include_once($pathWeb."panel/clases/InsertaPedido.class.php");
      include_once($pathWeb."panel/clases/EnviaEmailPedido.class.php");
      ...
      if($pedido->obtenExito()){
        ...
        $emailPedido = new EnviaEmailPedido($_SESSION, $_POST, Comunes::SAVE,$productos);
        $emailPedido->obtenExito();
      }
}
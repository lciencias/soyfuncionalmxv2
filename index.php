                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="grid-shop.html">Shop</a>
                      <!-- RD Navbar Dropdown-->
                      <ul class="rd-menu rd-navbar-dropdown">
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="grid-shop.html">Grid Shop</a></li>
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="shop-list.html">Shop List</a></li>
      ...
      <section class="section section-xxl bg-default">
        <div class="container">
          <div class="row row-30">
            <div class="col-sm-7 wow fadeInLeft"><a class="banner-modern-figure" href="grid-shop.html"><img src="images/banner-2-670x676.jpg" alt="" width="670" height="676"/></a></div>
            <div class="col-sm-5"><a class="banner-modern-figure wow fadeInRight" href="grid-shop.html"><img src="images/banner-3-470x395.jpg" alt="" width="470" height="395"/></a><a class="banner-modern-figure wow fadeInRight" href="grid-shop.html"><img src="images/banner-4-470x250.jpg" alt="" width="470" height="250"/></a></div>
          </div>
        </div>
      </section>
              ...
              <div class="card-group-custom card-group-custom-1 card-group-corporate" id="accordion1" role="tablist" aria-multiselectable="false">
                ...
                <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".2s">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a id="accordion1-card-head-fgelhcil" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-pxrsqqxs" aria-controls="accordion1-card-body-pxrsqqxs" aria-expanded="true" role="button">What do I receive when I order a template?
                        <div class="card-arrow">
                          <div class="icon"></div>
                        </div></a></div>
                  </div>
                  <div class="collapse show" id="accordion1-card-body-pxrsqqxs" aria-labelledby="accordion1-card-head-fgelhcil" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                ...
                <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".3s">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="collapsed" id="accordion1-card-head-tdwilgbj" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-jmiqvgxg" aria-controls="accordion1-card-body-jmiqvgxg" aria-expanded="false" role="button">In what formats are your templates available?
                        <div class="card-arrow">
                          <div class="icon"></div>
                        </div></a></div>
                  </div>
                  <div class="collapse" id="accordion1-card-body-jmiqvgxg" aria-labelledby="accordion1-card-head-tdwilgbj" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                ...
                <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".4s">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="collapsed" id="accordion1-card-head-rvojuomk" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-lttdipqt" aria-controls="accordion1-card-body-lttdipqt" aria-expanded="false" role="button">What am I allowed to do with the templates?
                        <div class="card-arrow">
                          <div class="icon"></div>
                        </div></a></div>
                  </div>
                  <div class="collapse" id="accordion1-card-body-lttdipqt" aria-labelledby="accordion1-card-head-rvojuomk" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
          ...
          <div class="container">
            <div class="row row-40 row-md-50 justify-content-xl-between">
              <div class="col-sm-6 col-lg-4 col-xl-3 wow fadeInRight">
                <div class="footer-classic-brand"><a class="brand" href="index.php"><img class="brand-logo-dark" src="images/logo-default-249x52.png" alt="" width="249" height="52"/><img class="brand-logo-light" src="images/logo-inverse-249x52.png" alt="" width="249" height="52"/></a>
                </div>
                ...
                <ul class="contacts-creative">
                  ...
                  <li>
                    <div class="unit unit-spacing-sm flex-column flex-md-row">
                      ...
                      <div class="unit-body"><a href="/cdn-cgi/l/email-protection#0b28"><span class="__cf_email__" data-cfemail="86efe8e0e9c6e2e3ebe9eaefe8eda8e9f4e1">[email&#160;protected]</span></a></div>
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div class="container">
            <div class="row row-10 align-items-center justify-content-sm-between">
              <div class="col-md-auto">
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Grocmart</span><span>.&nbsp;</span><span>All rights reserved</span></p>
              </div>
